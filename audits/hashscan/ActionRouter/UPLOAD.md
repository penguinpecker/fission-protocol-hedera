...
| Field | Value |
|-------|-------|
| Contract address (EVM) | `0x00000000000000000000000000000000009fad96` |
...
1. Open HashScan: https://hashscan.io/mainnet/contract/0x00000000000000000000000000000000009fad96
...
- The transaction hash that created `0x00000000000000000000000000000000009fad96` (visible on HashScan) — its input data tail is the abi-encoded args.
